...
namespace FastReport.Barcode.Aztec
{
   ...
   {
      public static readonly GenericGF AZTEC_DATA_12 = new GenericGF(0x1069, 4096, 1); // x^12 + x^6 + x^5 + x^3 + 1
      public static readonly GenericGF AZTEC_DATA_10 = new GenericGF(0x409, 1024, 1); // x^10 + x^3 + 1
      public static readonly GenericGF AZTEC_DATA_6 = new GenericGF(0x43, 64, 1); // x^6 + x + 1
      public static readonly GenericGF AZTEC_PARAM = new GenericGF(0x13, 16, 1); // x^4 + x + 1
